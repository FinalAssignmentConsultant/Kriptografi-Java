...
<%
        ...
        String entitas = "";
		String backto="";
        if (request.getParameter("Submit") != null && request.getParameter("Submit").equals("Enkrip")) {
...
<div class="intabbg">
  <div class="intabbtm">
    <div class="intabtop mbottom"><!-- InstanceBeginEditable name="hak_akses_halaman" -->hak_akses<!-- InstanceEndEditable -->
                                                        ...
                                                        <table width="60%" border="0" align="center">
                                                            <tr>
                                                              ...
                                                              <td valign="top"><%=tag%>
                                                                ...
                                                                <input name="backto" type="hidden" id="backto" value="<%=backto%>"/></td>
                                                            </tr>
                                                            <tr>
                                                                <td valign="top">Isi tag </td>
                                                                <td valign="top">:</td>
                                                                <td valign="top"><%=content%>
                                                                <input name="content" type="hidden" id="content" value="<%=content%>" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td valign="top">Password enkripsi </td>
                                                                <td valign="top">:</td>
                                                                <td valign="top"><label>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top">&nbsp;</td>
                                                                <td valign="top"><label>
                                                                        <input type="submit" name="Submit" value="Enkrip" />
                                                                </label></td>
                                                            </tr>
                                                        </table>
                                                    </form>
