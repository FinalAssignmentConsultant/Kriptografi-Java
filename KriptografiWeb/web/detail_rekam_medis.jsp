...
%>
<%
        xpath = "//pasien/riwayatpemeriksaan/pemeriksaan[idriwayatpenyakit='" + id + "']";
...
<%
    if(submit.equals("Proses")){
        String password = request.getParameter("passwordDekripsi")!=null?request.getParameter("passwordDekripsi"):"";
        tanggalpemeriksaan = Logic.safeDecrypt(tanggalpemeriksaan, password);
        keluhan = Logic.safeDecrypt(keluhan, password);
        diagnosa = Logic.safeDecrypt(diagnosa, password);
        pengobatan = Logic.safeDecrypt(pengobatan, password);
        tindakanmedis = Logic.safeDecrypt(tindakanmedis, password);
        keterangan = Logic.safeDecrypt(keterangan, password);
...
<div class="intabbg">
  <div class="intabbtm">
    <div class="intabtop mbottom"><!-- InstanceBeginEditable name="hak_akses_halaman" --><!-- InstanceEndEditable -->
      ...
      <p><a href="pencarian_data.jsp">Kembali</a>        </p>
      <form action="" method="post">
        <table width="81%" border="0" align="center">
          ...
          <%  if (!id.equals("")) {%>
          <tr>
            <td colspan="3"><h2>Kerahasiaan Data </h2></td>
            </tr>
          <tr>
            <td colspan="3">Jika Anda pasien yang berkepentingan terhadap data rekam medis ini, dan Jika Anda melihat data tidak dapat dibaca, maka silahkan masukkan nomor induk pasien ini untuk melihat data asli yang dapat dibaca. </td>
            </tr>
          <tr>
