...
<div class="intabbg">
  <div class="intabbtm">
    <div class="intabtop mbottom"><!-- InstanceBeginEditable name="hak_akses_halaman" -->hak_akses<!-- InstanceEndEditable -->
      <% if(LOGIN_PERAN.equals(hak_akses_halaman) || hak_akses_halaman.equals("")){%><!-- InstanceBeginEditable name="data" -->Program ini merupakan prototype dari Aplikasi Sekuritas Data XML pada Aplikasi Web Java dengan Algoritma Password Based Encription. .<!-- InstanceEndEditable --><% } %></div></div></div>
</div>
</div>
			  </div>
